...
# Markers for constraints
markerPrismatic = mbs.AddMarker(MarkerNodeCoordinate(nodeNumber=n0, coordinate=2))  # Z-position
markerRevolute1 = mbs.AddMarker(MarkerNodeCoordinate(nodeNumber=n1, coordinate=6))  # Rotation Z
markerRevolute2 = mbs.AddMarker(MarkerNodeCoordinate(nodeNumber=n2, coordinate=6))  # Rotation Z
markerRevolute3 = mbs.AddMarker(MarkerNodeCoordinate(nodeNumber=n3, coordinate=6))  # Rotation Z
...
# Constraints
constraintPrismatic = mbs.AddObject(CoordinateConstraint(markerNumbers=[markerPrismatic, markerGround], offset=0))
constraintRevolute1 = mbs.AddObject(CoordinateConstraint(markerNumbers=[markerRevolute1, markerGround], offset=0))
constraintRevolute2 = mbs.AddObject(CoordinateConstraint(markerNumbers=[markerRevolute2, markerGround], offset=0))
